...
class TimePunch(BaseMember):
    ...
    tc_related = Column("time punch related", Boolean, primary_key=True)
...
# testing samples
p1 = Person(139555666, "Bill", "Birdie", "Male", 46)
p2 = Person(169555888, "Bobbie", "Jenkins", "Male", 76)
p3 = Person(555444333, "Rhonda", "Boork", "Female", 45)
p4 = Person(989755187, "Derek", "Dongster", "Male", 55)
